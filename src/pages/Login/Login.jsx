    ...
    return (
        <>
            ...
            >
                ...
                ></div>
                <div
                    className="w-full max-w-lg rounded-xl p-8 space-y-8"
                    style={{
                ...
                >
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <button
                                ...
                                className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border text-white"
                                style={{
                    ...
                    <form onSubmit={handleSignIn} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            className="w-full px-4 py-2.5 rounded-lg text-white font-medium hover:opacity-90 transition-opacity"
                            style={{
